...
// Initialize varibles
const userUrl = "https://lhlfx7e4ch.execute-api.us-east-1.amazonaws.com/Production/userDetails";
sessionStorage.setItem("userUrl", userUrl);

const subscriptionUrl = "https://atvkxb0fg8.execute-api.us-east-1.amazonaws.com/Production/userSubscriptions";
sessionStorage.setItem("subscriptionUrl", subscriptionUrl);

const musicUrl = "https://0d04n3ii1k.execute-api.us-east-1.amazonaws.com/Production/musicDetails";
